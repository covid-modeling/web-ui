...
import {
  Intensity,
  InterventionPeriod as RunnerInterventionPeriod
...
export {Intensity} from '../types/model-runner'
...
export interface NewSimulationConfig {
  ...
  label: string
  r0: number | undefined
  interventionPeriods: RunnerInterventionPeriod[]
}
...
export interface InterventionPeriod
  extends Omit<RunnerInterventionPeriod, 'reductionPopulationContact'> {
...
function autoFillParameters(
  ...
  addIntervention('SchoolClose', 'schoolClosure', Intensity.Aggressive)
  addIntervention('GathRestrict10', 'socialDistancing', Intensity.Mild)
  addIntervention('StayAtHome', 'socialDistancing', Intensity.Moderate)
  addIntervention('StateCurfew', 'socialDistancing', Intensity.Moderate)
  ...
  let interventionPeriods: InterventionPeriod[] = rawInterventions
    ...
    .map(raw => ({
      ...
      voluntaryHomeQuarantine: Intensity.Aggressive,
      caseIsolation: Intensity.Aggressive,
